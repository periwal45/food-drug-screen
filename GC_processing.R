...
########## Plotting growth curves (Plotting_GrowthCurves.R)
# uses GC_fitted_model_values as input file to plot growth curves

########## below is the main analysis code
#' 1. Read fitted values and parameters
#' 2. filter out incomplete data (plate 16 (duloxetine) is excluded as it is not present for all bugs)
#' 3. 
